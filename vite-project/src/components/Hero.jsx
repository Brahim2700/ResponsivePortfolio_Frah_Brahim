    ...
    <header className="hero" id="home">
      <div className="hero__top">
        <div className="hero__image-wrapper">
          <img src={profileImg} alt="Frah Brahim" className="hero__image" />
        </div>
        <ThemeToggle />
      </div>
      ...
      <div className="hero__socials">
        <a 
          href="https://www.linkedin.com/in/frah-brahim" 
          target="_blank" 
        ...
        <a 
          href="https://github.com/Brahim2700" 
          target="_blank" 
          rel="noopener noreferrer"
          className="social-link"
          aria-label="GitHub"
        ...
        <a 
          href="https://www.youtube.com/@GISandGenieCivil" 
          target="_blank" 
          rel="noopener noreferrer"
          className="social-link"
          aria-label="YouTube"
